...
public class PhotoliciousUtils {
	...
	public static boolean configurationExists() {
		...
		try {
			...
			if (file.exists()) {
				...
				slideTime = p.getProperty("slideTime");
				printSize = p.getProperty("printSize");
				if (null != defaultPrinter && !"".equals(defaultPrinter)
						&& null != slideTime && !"".equals(slideTime)
						&& null != printSize && !"".equals(printSize)) {
					return true;
				}
			}
			return false;
	...
	public static ObservableList<PrintServiceVO> printerList() {
	...
	public static void main(String args[]) {
		System.out.println(new PhotoliciousUtils().configurationExists());
	}
}